          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            <FadeIn delay={0.1} y={30}>
              <p className="text-xl sm:text-2xl md:text-3xl font-semibold uppercase tracking-tight text-white leading-snug font-display" style={{ letterSpacing: '-0.02em' }}>
                We believe the digital world is dying of visual homogenization. Interactive design, 3D space, branding, and cinema shouldn't live in silos, they must converge to build memorable brands.
              </p>
            </FadeIn>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-[var(--colors-body-muted)] font-light font-sans text-sm sm:text-base leading-relaxed">
              <FadeIn delay={0.2} y={20}>
                <p>
                  Endrohex was founded as a collaborative rebellion against visual standards. We reject cookie-cutter templates, generic corporate assets, and uninspired media. Every design, model, video frame, and line of code is constructed from scratch to project your brand's distinct character.
                </p>
              </FadeIn>
              <FadeIn delay={0.25} y={20}>
                <p>
                  By combining fullstack engineering, high-fidelity 3D CGI, visual effects, and strategic creative direction under one roof, we eliminate fragmented communication and intermediate agency markups, creating cohesive digital realities with rapid iteration cycles.
                </p>
              </FadeIn>
            </div>
          </div>
          ...
          {[
            {
              ...
              desc: "We integrate web technology, 3D modelling, CGI, motion graphic composition, cinematic post-production, and branding into a single, cohesive workflow.",
              icon: <Compass size={16} />
            },
            {
              num: "02 // COLLABORATION",
              title: "Direct Specialist Loop",
              desc: "We eliminate intermediate project managers and account executives. You collaborate directly with the creators, developers, directors, and designers, shaping your project's code and assets.",
              icon: <Cpu size={16} />
            },
            {
              num: "03 // VERIFICATION",
              title: "Staged Milestones",
              desc: "Every client engagement is verified via a secure 3-step staging workflow. Review real-time previews of models, edits, code bases, and branding boards, approving milestones only when completely satisfied.",
              icon: <Award size={16} />
            }
          ].map((item, idx) => (
        ...
        <div className="flex flex-col gap-10 mt-6 border-t border-white/[0.08] pt-10 text-left">
          ...
          <div className="relative border-l border-white/[0.08] pl-6 sm:pl-8 ml-2 sm:ml-4 flex flex-col gap-8">
            {[
              {
                year: "2024",
                stage: "THE SPARK // THE CONVERGENCE",
                title: "United by Template Fatigue",
                desc: "Our core directors, developers, and visual designers connected online, united by a shared urge to rebel against visually stale, template-driven digital outputs. This cross-disciplinary synergy formed the ideological foundation of Endrohex."
              },
              {
                year: "2025",
                stage: "DISCIPLINE INTEG // PRODUCTION LOOP",
                title: "Consolidating Creative Pipelines",
                desc: "We spent the year aligning our pipelines, merging fullstack development protocols, high-fidelity 3D modeling pipelines, and cinematic post-production workflows into a single collaborative workspace. We honed our synergy by shipping projects globally."
              },
              {
                year: "2026",
                stage: "IMMERSIVE FRONTIERS // FULL-SERVICE AGENCY",
                title: "Launching the Multidisciplinary Force",
                desc: "We officially established Endrohex as a full-scale creative agency. Offering unified web development, 3D design, CGI, branding, motion graphics, and cinematic video production directly to brands seeking digital excellence."
              }
            ].map((milestone, idx) => (
