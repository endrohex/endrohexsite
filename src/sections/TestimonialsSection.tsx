...
const TESTIMONIALS_DATA: Testimonial[] = [
  {
    ...
    rating: 4,
    text: '"Endrohex delivered our Apple website replica in record time. The micro-interactions and smooth responsiveness on mobile screens absolutely blew our minds."',
    initials: "Si",
  ...
  },
  {
    ...
    rating: 3,
    text: '"Our interactive catalog looks spectacular. Aneek and Spandan possess an incredible sense of design details, transforming static images into an artistic storytelling canvas."',
    initials: "AG",
    avatarBg: "rgba(0, 102, 204, 0.05)",
    avatarText: "var(--colors-primary)",
  ...
  },
  {
    ...
    rating: 5,
    text: '"The direct communication approach is a lifesaver. No middleman interfaces meant changes were coordinated instantly. We highly recommend Endrohex for modern corporate pages."',
    initials: "AR",
    avatarBg: "rgba(0, 102, 204, 0.05)",
    avatarText: "var(--colors-primary)",
  ...
  },
  {
    ...
    role: "A student",
    rating: 5,
    text: '"The birthday site is so cutesy and adorable, I loved the dedication and hardwork they put into it. Its cute 💖"',
    initials: "Ny",
    avatarBg: "rgba(0, 102, 204, 0.05)",
    avatarText: "var(--colors-primary)",
  ...
  },
  {
    ...
    rating: 5,
    text: '"Endrohex built the dark storytelling atmosphere we envisioned flawlessly. Their command over Three.js and custom canvas animations is world-class."',
    initials: "YM",
    avatarBg: "rgba(0, 102, 204, 0.05)",
    avatarText: "var(--colors-primary)",
  ...
  },
  {
    ...
    rating: 5,
    text: '"Unbelievable dynamic code quality. Our landing conversion rates jumped by 40% after implementing their clean performance recommendations. Five stars all around."',
    initials: "EB",
    avatarBg: "rgba(0, 102, 204, 0.05)",
    avatarText: "var(--colors-primary)",
