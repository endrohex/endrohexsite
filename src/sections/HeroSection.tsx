      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center gap-8 md:gap-10">
        ...
        <FadeIn delay={0.1} y={30} className="w-full text-center flex flex-col items-center gap-4 md:gap-5">
          ...
          <div className="flex items-center gap-2 text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.25em] text-[var(--colors-ink-muted-80)] mb-1">
            <span>SYS-PORT: ACTIVE // MULTIDISCIPLINARY CREATIVE AGENCY</span>
          </div>
          ...
          <p className="text-[var(--colors-ink-muted-80)] text-xs sm:text-base max-w-2xl mx-auto font-light leading-relaxed tracking-wide font-sans px-2">
            A premium multidisciplinary creative agency delivering high-end web development, 3D design, visual effects, branding, motion graphics, and cinematic video production.
          </p>
              ...
              <div className="w-full h-full bg-[#050D1E] flex flex-col justify-between p-4 sm:p-6 relative text-left select-none">
                ...
                <div className="flex justify-between items-start relative z-10 w-full">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] sm:text-xs font-bold text-white uppercase tracking-wider font-display mt-0.5">Endrohex Creative Engine</span>
                  </div>
                </div>
                ...
                <div className="my-auto flex flex-col gap-0.5 sm:gap-1 relative z-10">
                  ...
                  <p className="text-[8px] sm:text-[9px] text-white/50 leading-relaxed font-light font-sans max-w-[240px] hidden sm:block">
                    Integrating web technologies, 3D assets, cinematic VFX, and dynamic branding systems in unison.
                  </p>
                </div>
        ...
        <FadeIn delay={0.3} y={30} className="w-full mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
            {[
              {
                icon: <Radio size={16} />,
                title: "SYS-01 // CREATIVE DIVISION",
                desc: "High-end 3D environments, graphic branding, motion graphics, visual effects, and design direction."
              },
              {
                icon: <Cpu size={16} />,
                title: "SYS-02 // TECH DIVISION",
                desc: "Scalable React platforms, responsive systems, fullstack integration, and performance-tuned applications."
              },
              {
                icon: <ShieldCheck size={16} />,
                title: "SYS-03 // PRODUCTION DIVISION",
                desc: "Cinematic video editing, color grading, CGI, cinematography, and creative media campaigns."
              }
            ].map((badge, bIdx) => (
              <div
                key={bIdx}
