...
function App() {
  ...
  const [selectedPriceUSD, setSelectedPriceUSD] = useState<number | string | null>(null);
  const [selectedPriceINR, setSelectedPriceINR] = useState<number | string | null>(null);
  ...
  const handleSelectPlan = (planName: string, priceUSD: number | string) => {
    setSelectedPlan(planName);
    setSelectedPriceUSD(priceUSD);
    setSelectedPriceINR(priceUSD === "Custom" ? "Custom" : Number(priceUSD) * 100);

    triggerToast(`Selected Package: ${planName}`);
  ...
  const handleResetPlan = () => {
    ...
    setSelectedPriceUSD(null);
    setSelectedPriceINR(null);
  };
    ...
    >
      ...
      <div className="fixed top-0 left-0 w-full h-11 bg-[var(--colors-surface-black)] z-50 flex items-center px-4 md:px-8 border-b border-white/[0.08]">
        <div className="w-full max-w-5xl mx-auto flex justify-between items-center">
          ...
          <a href="#home" className="flex items-center gap-1.5 text-xs font-black text-white uppercase tracking-[0.15em] font-display">
            <span>Endrohex</span>
            <div className="w-1.5 h-1.5 rounded-full bg-[var(--colors-primary-on-dark)] shadow-[0_0_8px_rgba(41,151,255,0.6)] animate-pulse" />
          </a>
          ...
          <nav className="hidden md:flex items-center gap-6">
            {[
              ...
              { label: "Engineers", href: "#kyd" },
              { label: "Costing", href: "#pricing" },
        ...
        <div className="w-full max-w-5xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden sm:inline text-xs text-[var(--colors-ink-muted-80)] font-medium">
              Direct Dev Access // No Middlemen
            </span>
            <a
              href="#pricing"
          ...
          >
            <ul className="flex flex-col gap-3">
              {[
                ...
                { label: "Engineering Team", href: "#kyd" },
                { label: "Milestone Costing", href: "#pricing" },
                { label: "Console Archives", href: "#projects" },
                { label: "Founder Reviews", href: "#testimonials" },
                { label: "Support protocols", href: "#faq" },
      ...
      <main>
        ...
        <ContactSection
          ...
          selectedPriceUSD={selectedPriceUSD}
          selectedPriceINR={selectedPriceINR}
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 w-full">
          ...
          <div className="flex flex-col gap-4">
            <a href="#home" className="flex items-center gap-1.5 text-base font-black text-white uppercase tracking-[0.15em] font-display">
              <span>Endrohex</span>
              <div className="w-1.5 h-1.5 rounded-full bg-[#00F2FE] shadow-[0_0_8px_#00F2FE] animate-pulse" />
            </a>
            <p className="text-xs text-white/50 leading-relaxed font-light font-sans">
              Designing and engineering premium luxury web platforms that redefine standard interaction guidelines. Fast, robust, and accessible.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-xs text-white/50 font-light font-sans">
              ...
              <li><a href="#kyd" className="hover:text-[#00F2FE] hover:pl-1 transition-all">// Engineering Team</a></li>
              <li><a href="#pricing" className="hover:text-[#00F2FE] hover:pl-1 transition-all">// Costing Indexes</a></li>
              <li><a href="#projects" className="hover:text-[#00F2FE] hover:pl-1 transition-all">// Console Archives</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-xs text-white/50 font-light font-sans">
              ...
              <li><a href="#contact" className="hover:text-[#00F2FE] hover:pl-1 transition-all">// intake form</a></li>
              <li>
